...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/linkedin-api-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14684&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/linkedin-api-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `linkedin-api` can be installed with:

```
conda install linkedin-api
```

It is possible to list all of the versions of `linkedin-api` available on your platform with:
